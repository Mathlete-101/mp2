...
def generate_launch_description():
    return LaunchDescription([
        ...
        Node(
            ...
            arguments=['/model/four_wheeled_robot/camera/depth@sensor_msgs/msg/Image@ignition.msgs.Image'],
            remappings=[
                ('/model/four_wheeled_robot/camera/depth', '/camera/depth'),
            ],
            output='screen',
            parameters=[{
                'config_file': '',
        ...
        # Image view for depth camera
        Node(
            package='rqt_image_view',
            executable='rqt_image_view',
            name='depth_camera_view',
